...
export const accordionData = [
    {
      ...
      plus: <div className="ms-auto" style={{padding:"0px 5px", fontSize:"10px", border: "1px solid cyan", borderRadius:"10%", color: "white", pointerEvents: "none"}} >29</div>,
      minus: <div className="ms-auto" style={{padding:"0px 5px", fontSize:"10px", border: "1px solid cyan", borderRadius:"10%", color: "white",pointerEvents: "none"}} >29</div>,
    },
    {
      title: 'SUMMARY',
